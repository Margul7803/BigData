...
df_bronze_1 = spark.read.csv(bronze_input_path_1, header=True, inferSchema=True)
df_bronze_2 = spark.read.csv(bronze_input_path_2, header=True, inferSchema=True)
...
df_bronze_1_clean.write.format("delta").mode("overwrite").save(bronze_output_path_1)
df_bronze_2_clean.write.format("delta").mode("overwrite").save(bronze_output_path_2)
df_bronze_3_clean.write.format("delta").mode("overwrite").save(bronze_output_path_3)
